        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Petugas LB1</span>
            </a>
            <ul class="dropdown-menu">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <li><a href="<?=site_url('laporan_bulanan/statusLB')?>"><i class="fa fa-fw fa-file-excel-o"></i> Status LB1</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?=site_url('laporan_bulanan/viewCetak')?>"><i class="fa fa-fw fa-file-excel-o"></i> Laporan Bulanan</a></li>
            <li><a href="<?=site_url('laporan_bulanan/viewCetakTribln')?>"><i class="fa fa-fw fa-file-excel-o"></i> Laporan Tribulan</a></li>
            <li><a href="<?=site_url('laporan_bulanan/viewCetakTahun')?>"><i class="fa fa-fw fa-file-excel-o"></i> Laporan Tahunan</a></li>
          </ul>
        </li>
      </ul>
    </section>
