            ...
            <div class="modal fade" id="kirim">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo site_url('dinkes/accLB1/'. $peny_bln[0]->id_laporan); ?>" method="post">
              ...
              <div class="modal fade" id="eval">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo site_url('dinkes/evaluasiLB1/'. $peny_bln[0]->id_laporan); ?>" method="post">
                    <div class="modal-body">
                    <div class="form-group">
